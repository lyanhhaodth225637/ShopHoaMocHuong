                ...
                <div class="card">
                    <div class="card-body p-2">
                        <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                            <button class="nav-link active text-start mb-1" id="tab-hero-btn"
                                data-bs-toggle="pill" data-bs-target="#tab-hero" type="button" role="tab">
                                <i class="ti ti-layout-navbar me-2"></i> Hero trang chủ
                            </button>

                            <button class="nav-link text-start mb-1" id="tab-slides-btn"
                                data-bs-toggle="pill" data-bs-target="#tab-slides" type="button" role="tab">
                                <i class="ti ti-photo me-2"></i> Slider ảnh nền
                            </button>

                            <button class="nav-link text-start mb-1" id="tab-stats-btn"
                                data-bs-toggle="pill" data-bs-target="#tab-stats" type="button" role="tab">
                                <i class="ti ti-chart-bar me-2"></i> Thống kê Hero
                            </button>

                            <button class="nav-link text-start mb-1" id="tab-theme-btn"
                                data-bs-toggle="pill" data-bs-target="#tab-theme" type="button" role="tab">
                                <i class="ti ti-palette me-2"></i> Màu sắc & Theme
                            </button>

                            <button class="nav-link text-start mb-1" id="tab-layout-btn"
                                data-bs-toggle="pill" data-bs-target="#tab-layout" type="button" role="tab">
                                <i class="ti ti-layout me-2"></i> Bố cục trang
                            </button>

                            <button class="nav-link text-start mb-1" id="tab-font-btn"
                                data-bs-toggle="pill" data-bs-target="#tab-font" type="button" role="tab">
                                <i class="ti ti-typography me-2"></i> Phông chữ
                            </button>

                            <button class="nav-link text-start mb-1" id="tab-logo-btn"
                                data-bs-toggle="pill" data-bs-target="#tab-logo" type="button" role="tab">
                                <i class="ti ti-brand-tabler me-2"></i> Logo & Banner
                            </button>

                            <button class="nav-link text-start mb-1" id="tab-footer-btn"
                                data-bs-toggle="pill" data-bs-target="#tab-footer" type="button" role="tab">
                                <i class="ti ti-layout-bottombar me-2"></i> Footer
                            </button>

                            <button class="nav-link text-start" id="tab-advanced-btn"
                                data-bs-toggle="pill" data-bs-target="#tab-advanced" type="button" role="tab">
                                    ...
                                    <div class="row g-3">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="text-secondary small">
                                                Ảnh nên dùng định dạng jpg, png hoặc webp. Kích thước nên vuông để hiển thị đẹp trong khung tròn.
                                            </div>
                                        </div>
