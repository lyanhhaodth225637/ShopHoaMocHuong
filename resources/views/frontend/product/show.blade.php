...
@section('meta_description', $product->meta_description ?? $product->short_description ?? ('Khám phá sản phẩm ' . $product->name . ' tại Hoa Gỗ Mộc Hương với thiết kế tinh tế và giao hàng nhanh tại Long Xuyên.'))
...
@section('og_description', $product->meta_description ?? $product->short_description ?? ('Sản phẩm ' . $product->name . ' tại Hoa Gỗ Mộc Hương.'))
